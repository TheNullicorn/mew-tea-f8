...
/**
 * Creates a [OkioMutf8Sink] around the receiver, [writes][OkioMutf8Sink.writeLength] the
 * [mutf8Length][CharSequence.mutf8Length] of the [characters], and then [writes][OkioMutf8Sink.writeFromSequence] the
 ...
 * @see[OkioMutf8Sink]
 * @see[OkioMutf8Sink.writeLength]
 * @see[OkioMutf8Sink.writeFromSequence]
 */
@Throws(IOException::class)
@JvmName("writeSequenceTo")
@JvmOverloads
fun Sink.writeMutf8Sequence(
...
/**
 * Creates a [OkioMutf8Sink] around the receiver, [writes][OkioMutf8Sink.writeLength] the
 * [mutf8Length][CharArray.mutf8Length] of the [characters], and then [writes][OkioMutf8Sink.writeFromArray] the
 * [characters] themselves.
 *
 * In code, that would be:
 * ```kotlin
 ...
 * @see[OkioMutf8Sink]
 * @see[OkioMutf8Sink.writeLength]
 * @see[OkioMutf8Sink.writeFromArray]
 */
@Throws(IOException::class)
@JvmName("writeArrayTo")
@JvmOverloads
fun Sink.writeMutf8Array(
...
private inline fun <C> Sink.writeMutf8(
    characters: C,
    bytesPerWrite: Int,
